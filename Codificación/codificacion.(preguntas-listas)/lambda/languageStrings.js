    ...
    es: {
        translation: {
            ...
            FACTS:
                ...
                DOUBT_MSG:
                [
                    'Claro, dime que pasa ,te puedo ayudar respondiendo alguna de las  siguientes preguntas más  frecuentes: ¿cuáles son las ventajas de la IA?, ¿Quién y cuándo se invento la Inteligencia Artificial?, ¿Por qué necesitamos la inteligencia artificial? ',
                    'Claro, dime que pasa ,te puedo ayudar respondiendo alguna de las  siguientes preguntas más  frecuentes: ¿Qué es la inteligencia artificial?, ¿Cómo funciona el aprendizaje automático?, ¿Por qué es importante la IA?'
                    ],
                ANSWER:
                [
                   '1. Se minimizan los errores, 2. LA IA es compatible con numerosos sectores e industrias, 3. La inteligencia artificial optimiza al máximo.',
                ],
